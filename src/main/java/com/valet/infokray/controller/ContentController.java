...
public class ContentController {
    ...
    public ResponseEntity<?> content(@AuthenticationPrincipal Person person, @RequestBody Content content){
        try {
    ...
    public ResponseEntity<?> getContent(@RequestParam(defaultValue = "0") int page,
    ...
    public ResponseEntity<?> content(@AuthenticationPrincipal Person person, @RequestParam("files") List<MultipartFile> files, @RequestParam("content") String content){
        try {
