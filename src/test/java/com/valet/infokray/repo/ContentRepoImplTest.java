...
class ContentRepoImplTest {
    ...
    @Test
    void saveContent() {
        Content content = new Content(null, "Test", "Body", List.of("123", "321"), ContentType.EVENT, 5L);
    ...
    void search() {
        ...
        List<Content> contents = List.of(
                Content.builder().creatorId(5L).type(ContentType.EVENT).images(images).name("Test 1").build(),
                Content.builder().creatorId(5L).type(ContentType.EVENT).images(images).name("Test 2").build(),
                Content.builder().creatorId(5L).type(ContentType.EVENT).images(images).name("Test 3").build(),
                Content.builder().creatorId(5L).type(ContentType.EVENT).images(images).name("111").build(),
                Content.builder().creatorId(5L).type(ContentType.EVENT).images(images).name("444").build(),
                Content.builder().creatorId(5L).type(ContentType.EVENT).images(images).name("Content6").build());
